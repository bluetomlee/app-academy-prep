...
describe "#translate" do
  ...
  it "retains punctuation at end of words" do
    s = translate("the quick, brown, sly fox")
    expect(s).to eq("ethay ickquay, ownbray, slyay oxfay")
  end

  it "capitalizes pig-latinized word if original word was capitalized" do
    s = translate("John was an American")
    expect(s).to eq("Ohnjay asway anay Americanay")
  end
